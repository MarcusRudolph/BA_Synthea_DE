    ...
    if (ethnicity.equals("hispanic")) {
      ...
      switch (race) {
        ...
        case "white":
          ...
          whiteLanguageUsage.add(0, "italian");
          whiteLanguageUsage.add(0, "french");
          whiteLanguageUsage.add(1, "german");
          whiteLanguageUsage.add(0, "polish");
          whiteLanguageUsage.add(0, "portuguese");
          whiteLanguageUsage.add(0, "russian");
          whiteLanguageUsage.add(0, "greek");
          whiteLanguageUsage.add(0, "english");
